    ...
    <div className="flex h-screen bg-gray-100 overflow-hidden">
      ...
      `}>
        ...
        <div className="p-5 border-b border-indigo-700 flex items-center gap-3">
          <div className="bg-indigo-500 w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0">
        ...
        <div className="p-4 border-t border-indigo-700">
          <div className="flex items-center gap-3">
            <div className="bg-indigo-500 w-9 h-9 rounded-full flex items-center justify-center font-bold text-sm flex-shrink-0">
        ...
        <header className="bg-white shadow-sm px-4 lg:px-6 py-3 flex items-center justify-between flex-shrink-0">
          <div className="flex items-center gap-3">
            <button
              ...
              className="lg:hidden text-gray-500 hover:text-indigo-600 transition-colors p-1.5 rounded-lg hover:bg-gray-100"
            >
              <Menu size={20} />
            </button>
